...
export const TaskDetailHeader = ({
  ...
  return (
    <div className="flex items-center justify-between px-6 py-4.5 border-b border-gray-border/50 bg-[#161616]/40 select-none shrink-0">
      <div className="flex items-center gap-2">
        <button
          onClick={onClose}
          className="lg:hidden p-1.5 hover:bg-[#202020] text-text-secondary hover:text-text-primary rounded-lg cursor-pointer"
        ...
        <div className="flex items-center gap-1 text-[11px] font-bold text-text-secondary bg-[#202020] border border-gray-border px-2.5 py-1.5 rounded-xl relative hover:text-text-primary transition-all shrink-0">
          ...
          />
          <span>{detailDueDate || 'Date and Reminder'}</span>
        </div>
        ...
        <div className="flex items-center gap-1 text-[11px] font-bold text-text-secondary bg-[#202020] border border-gray-border px-2.5 py-1.5 rounded-xl relative hover:text-text-primary transition-all shrink-0">
          ...
          <select
            ...
            className="bg-transparent border-0 p-0 text-[11px] font-bold text-text-secondary hover:text-text-primary focus:ring-0 focus:outline-hidden cursor-pointer w-auto max-w-[120px] truncate pr-4"
          >
      ...
      <div className="flex items-center gap-1.5">
        <div className="flex items-center bg-[#202020] border border-gray-border px-2.5 py-1.5 rounded-xl gap-2 relative select-none">
          <button
            onClick={() => {
              setDetailPriority(1);
