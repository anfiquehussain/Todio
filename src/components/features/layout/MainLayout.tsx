    ...
    <>
      <div className="flex min-h-screen bg-bg-primary text-text-primary h-screen overflow-hidden font-sans relative">
        ...
        {isMobileMenuOpen && (
          ...
          >
            <div className="w-[296px] h-full relative z-50 animate-slide-in flex bg-bg-secondary">
              <SidebarRail
                user={user}
                soundEnabled={soundEnabled}
                isLoading={isLoading}
                ...
                handleSync={handleSync}
                handleToggleSound={handleToggleSound}
                className="flex flex-col justify-between items-center bg-bg-secondary border-r border-gray-border/50 py-6 w-14 shrink-0 h-full relative z-20"
              />
              ...
              <div className="flex-1 relative h-full flex flex-col min-w-0">
                <div className="absolute top-4 right-4 z-50">
                  <button
                    ...
                    className="w-11 h-11 flex items-center justify-center hover:bg-[#222] rounded-xl text-text-secondary cursor-pointer"
